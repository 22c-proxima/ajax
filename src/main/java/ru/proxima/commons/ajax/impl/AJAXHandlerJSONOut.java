...
/**
 * Умолчания реализации классов-обработчиков AJAX-запросов для типа JSON_OUTPUT
 * @author Шомин Владимир, ЗАО ИВЦ Инсофт
 */
public abstract class AJAXHandlerJSONOut extends CommonAJAXHandler {
/**
 ...
 * @return AJAXHandlerType AJAXHandlerType.JSON_OUTPUT
 */
	public final AJAXHandlerType getHandlerType() {
		return AJAXHandlerType.JSON_OUTPUT;
	}
/**
 ...
 */
	public abstract Object process(AJAXRequest request) throws AJAXExecuteException;
/**
