...
/**
 * Умолчания реализации классов-обработчиков AJAX-запросов для типа JSON_INPUT
 * @author Шомин Владимир, ЗАО ИВЦ Инсофт
 */
public abstract class AJAXHandlerJSONIn extends CommonAJAXHandler {
/**
 ...
 */
	public abstract void process(JSONObject params, PrintWriter out)
