...
/**
 * Умолчания реализации классов-обработчиков AJAX-запросов для типа TEXT
 * @author Шомин Владимир, ЗАО ИВЦ Инсофт
 */
public abstract class AJAXHandlerText extends CommonAJAXHandler {
/**
 ...
 * @return AJAXHandlerType AJAXHandlerType.TEXT
 */
	public final AJAXHandlerType getHandlerType() {
		return AJAXHandlerType.TEXT;
	}
/**
 ...
 */
	public abstract void process(AJAXRequest request, PrintWriter out) throws AJAXExecuteException;
/**
