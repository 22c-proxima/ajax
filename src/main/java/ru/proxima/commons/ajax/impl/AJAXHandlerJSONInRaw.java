...
/**
 * Умолчания реализации классов-обработчиков AJAX-запросов для типа JSON_INPUT_RAW
 * @author Шомин Владимир, ЗАО ИВЦ Инсофт
 */
public abstract class AJAXHandlerJSONInRaw extends CommonAJAXHandler {
/**
 ...
 * @return AJAXHandlerType AJAXHandlerType.JSON_INPUT_RAW
 */
	public final AJAXHandlerType getHandlerType() {
		return AJAXHandlerType.JSON_INPUT_RAW;
	}
/**
 ...
 */
	public final String getContentType() {
		throw new UnsupportedOperationException("Для данного обработчика этот метод не имеет смысла");
	}
/**
 ...
 */
	public abstract void process(JSONObject params, AJAXResponse response)
		throws AJAXExecuteException;
/**
